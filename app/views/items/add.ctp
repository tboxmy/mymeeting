...
<h2>
<?php echo __('Add',true).' '.$item_name;?>
</h2>

<fieldset>
<legend><?php echo __('Add',true).' '.$item_name;?></legend>
    <div class="fieldset-inside">
    <p class="note"><?php __('Short name must be unique within this committee.')?></p>
    <?php echo $form->create('Item',array('url'=>array('action'=>'add','controller'=>'items','committee'=>$dcommittee['Committee']['short_name']))); ?>
    <?php
